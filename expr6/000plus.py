...
# 如果希望弹窗显示图片，可以尝试使用 'TkAgg' 或 'Qt5Agg'
import matplotlib
...
AE_NOISE_STD = 0.1
# 权重衰减 (L2 正则化)
WEIGHT_DECAY = 1e-4  # 新增：引入 L2 正则化
# 学习率
LR = 1e-3
# 数据路径
DATA_PATH = 'covid19'
# 模型保存路径
AE_MODEL_PATH = './autoencoder_model_para.pth'
CNN_MODEL_PATH = './cnn_model_para.pth'
# 可视化输出目录 (新增)
OUTPUT_DIR = 'output1.0_para'
...
class CNN(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.fc3 = nn.Linear(in_features=32, out_features=len(CLASS_NAMES))
